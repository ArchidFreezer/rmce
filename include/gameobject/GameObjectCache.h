...
public:
	 ...
	 *
	 * @param other GameObjectCache to copy
	 */
	GameObjectCache(const GameObjectCache& other) = delete;
	/**
	 * @brief Assignment operator
	 *
	 * This is removed as there should one be a single cache instance
	 *
	 * @param other GameObjectCache to assign
	 * @return New cache object
	 */
	GameObjectCache& operator=(const GameObjectCache& other) = delete;
	 ...
	 * @param other GameObjectCache to copy
	 */
	GameObjectCache(GameObjectCache&& other) = delete;
	/**
	 ...
	 * @return New cache object
	 */
	GameObjectCache& operator=(GameObjectCache&& other) = delete;
