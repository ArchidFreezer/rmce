...
struct Config {
	...
	std::map<const rm::rule::ForagableData*, int> herb_lore_bonuses{}; /**< Map of foragable resources and any herb lore skill bonuses from items (book) or familiarity with specific plants */
};
