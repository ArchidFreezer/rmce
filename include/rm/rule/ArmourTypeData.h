 ...
 *
 * Less cumbersome armour types have the advantage of providing the wearer with mobility. Fewer swings will make contact because the agile defender will completely avoid the blows. However, when a swing does make contact, the result is
 * usually more severe than it would be against the more cumbersome armour types: frequent and severe criticals along with more concussion hits are the rule.
 *
...
public:
	...
	inline static std::string prefix_{"ARMOURTYPE"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setType(ArmourType::Type type) {
		type_ = type;
	}
	 ...
	 */
	void setMinManoeuvreMod(int mod) {
		min_manoeuvre_mod_ = mod;
	}
	 ...
	 */
	int minManoeuvreMod() const {
		return min_manoeuvre_mod_;
	}
	 ...
	 * @param mod Minimum modification possible when fully trained in the armours use
	 */
	void setMaxManoeuvreMod(int mod) {
		max_manoeuvre_mod_ = mod;
	}
	 ...
	 * @return Minimum modification possible when fully trained in the armours use
	 */
	int maxManoeuvreMod() const {
		return max_manoeuvre_mod_;
	}
	 ...
	 */
	void setMissileAttackPenalty(int penalty) {
		missile_attack_penalty_ = penalty;
	}
	 ...
	 */
	int missileAttackPenalty() const {
		return missile_attack_penalty_;
	}
	 ...
	 */
	void setQuicknessPenalty(int penalty) {
		quickness_penalty_ = penalty;
	}
	 ...
	 */
	int quicknessPenalty() const {
		return quickness_penalty_;
	}
	 ...
	 */
	void setAnimalOnly(bool animal_only) {
	 ...
	 */
	void setIncludesGreaves(bool greaves) {
		includes_greaves_ = greaves;
	}
	 ...
	 */
	bool includesGreaves() const {
		return includes_greaves_;
	}
