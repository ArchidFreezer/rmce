...
public:
	...
	inline static std::string prefix_{"CLIMATE"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setTemperature(HabitatType::Temperature temperature) {
	 ...
	 */
	HabitatType::Temperature temperature() const {
		return temperature_;
	}
	 ...
	 */
	void addPrecipitation(HabitatType::Precipitation precipitation) {
		if (!hasPrecipitaton(precipitation))
			precipitations_.emplace(precipitation);
	}
	 ...
	 */
	void setPrecipitations(std::set<HabitatType::Precipitation> precipitations) {
		precipitations_ = std::move(precipitations);
	}
	 ...
	 */
	const std::set<HabitatType::Precipitation> precipitations() const {
