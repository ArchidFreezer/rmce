...
public:
	...
	inline static std::string prefix_{"DISEASE"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setType(const DiseaseTypeData& disease_type_data) {
		disease_type_data_ = &disease_type_data;
	}
