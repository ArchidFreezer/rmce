 ...
 *
 * There are multiple books that have been printed with Rolemaster rules and guidelines over the years, some of which have been made obsolete.
 *
 */
...
public:
	...
	inline static std::string prefix_{"BOOK"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setAbbreviation(std::string_view abbreviation) {
