...
public:
	...
	inline static std::string prefix_{"CREATUREPACE"}; /**< Prefix for the ID of the data objects */
	...
	std::string_view prefix() const override {
		return CreaturePaceData::prefix_;
	}
	 ...
	 */
	void setMovementRateMultiplier(float movement_rate_multiplier) {
		movement_rate_multiplier_ = movement_rate_multiplier;
	}
	 ...
	 */
	float movementRateMultiplier() const {
		return movement_rate_multiplier_;
	}
	 ...
	 */
	void setExhaustionCostMultiplier(float exhaustion_cost_multiplier) {
		exhaustion_cost_multiplier_ = exhaustion_cost_multiplier;
	}
	 ...
	 */
	float exhaustionCostMultiplier() const {
		return exhaustion_cost_multiplier_;
	}
	 ...
	 */
	void setManoeuvreDifficultyType(rule::enums::ManoeuvreDifficultyType::Type manoeuvre_difficulty_type) {
		manoeuvre_difficulty_type_ = manoeuvre_difficulty_type;
	}
	 ...
	 */
	rule::enums::ManoeuvreDifficultyType::Type manoeuvreDifficultyType() const {
		return manoeuvre_difficulty_type_;
	}
