...
/**
 * @brief Contains the ForagableEffectType::Type enum and associated functions
 *
...
enum class Type {
	...
	kIntoxicant,
	kLifePreservation,
	kMuscleCartilageTendonRepair,
	kMusclePoison,
	kNervePoison,
	kNerveRepair,
	kOrganRepairPreservation,
	kPhysicalAlterationEnhancement,
	kReductionPoison,
	kRespitoryPoison,
	kStatModifier,
	kStunRelief
 ...
 * @param type The ForagableEffectType::Type to get the string of
 * @return Game display form of the enum value as a string
 */
const std::string toString(Type type);

/**
 * @brief Teach operator<< how to print a ForagableEffectType::Type
 ...
 * @see toString()
 */
void fromString(std::string_view sv, ForagableEffectType::Type& type);
