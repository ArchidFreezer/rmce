 ...
 *
 * It is invalid to have both skill category stats and also to use the characters realm stats as these are mutually exclusive options.
 */
...
public:
	...
	inline static std::string prefix_{"SKILL"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setActionType(::SkillActionType::Type action_type) {
	 ...
	 */
	::SkillActionType::Type actionType() const {
		return action_type_;
	}
	 ...
	 */
	void setDifficultySummary(std::string_view difficulty_summary) {
		difficulty_summary_ = difficulty_summary;
	}
	 ...
	 */
	const std::string& difficultySummary() const {
		return difficulty_summary_;
	}
	 ...
	 */
	void setIsRestricted(bool restricted) {
	 ...
	 */
	void setCategory(const SkillCategoryData& category) {
		category_ = &category;
	}
	 ...
	 */
	const SkillCategoryData& category() const {
		return *category_;
	}
	 ...
	 */
	void setCanSpecialise(bool can_specialise) {
		can_specialise_ = can_specialise;
	}
	 ...
	 */
	void setMandatorySubcategory(bool mandatory_subcategory) {
		mandatory_subcategory_ = mandatory_subcategory;
	}
	 ...
	 */
	bool mandatorySubcategory() const {
		return mandatory_subcategory_;
	}
	...
	void addSubcategory(std::string subcategory) {
		subcategories_.insert(subcategory);
	}
	 ...
	 */
	void setSubcategories(std::set<std::string> subcategories) {
	 ...
	 */
	const std::set<std::string>& subcategories() const {
	 ...
	 */
	void setExhaustionCost(float cost) {
		exhaustion_cost_ = cost;
	}
	 ...
	 */
	float exhaustionCost() const {
		return exhaustion_cost_;
	}
	 ...
	 */
	void setDistanceMultiplier(float distance_multiplier) {
	 ...
	 */
	float distanceMultiplier() const {
