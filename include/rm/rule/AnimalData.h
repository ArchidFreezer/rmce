...
public:
	...
	inline static std::string prefix_{"ANIMAL"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setBaseHits(int base_hits) {
	 ...
	 */
	void setBaseMovement(int base_movement) {
		base_movement_ = base_movement;
	}
	 ...
	 */
	void setDefensiveBonus(int defensive_bonus) {
		defensive_bonus_ = defensive_bonus;
	}
	 ...
	 */
	int defensiveBonus() const {
		return defensive_bonus_;
	}
	 ...
	 */
	int frequencyFactor() const {
		return frequency_factor_;
	}
	 ...
	 */
	void setRidingBonus(int riding_bonus) {
		riding_bonus_ = riding_bonus;
	}
	 ...
	 */
	int ridingBonus() const {
		return riding_bonus_;
	}
	 ...
	 */
	void setMovingManoeuvreBonus(int moving_manoeuvre_bonus) {
		moving_manoeuvre_bonus_ = moving_manoeuvre_bonus;
	}
	 ...
	 */
	int movingManoeuvreBonus() const {
		return moving_manoeuvre_bonus_;
	}
	 ...
	 */
	void setBonusXpCode(CreatureBonusXpType::Type bonus_xp_code) {
		bonus_xp_code_ = bonus_xp_code;
	}
	 ...
	 */
	CreatureBonusXpType::Type bonusXpCode() const {
		return bonus_xp_code_;
	}
	 ...
	 */
	void setConstitutionVarianceType(CreatureConstitutionVarianceType::Type constitution_variance_type) {
		constitution_variance_type_ = constitution_variance_type;
	}
	 ...
	 */
	CreatureConstitutionVarianceType::Type constitutionVarianceType() const {
		return constitution_variance_type_;
	}
	 ...
	 */
	void setTreasureCode(const TreasureCodeData& treasure_code) {
		treasure_code_ = &treasure_code;
	}
	 ...
	 */
	const std::optional<const TreasureCodeData*> treasureCode() const {
		return treasure_code_;
	}
	 ...
	 */
	void setSize(CreatureSizeType::Type size) {
		size_ = size;
	}
	 ...
	 */
	CreatureSizeType::Type size() const {
		return size_;
	}
	 ...
	 */
	void setArmourType(ArmourType::Type armour_type) {
		armour_type_ = armour_type;
	}
	 ...
	 */
	ArmourType::Type armourType() const {
		return armour_type_;
	}
	 ...
	 */
	void setMovementSpeed(CreatureMovementSpeedType::Type movement_speed) {
	 ...
	 */
	CreatureMovementSpeedType::Type movementSpeed() const {
	 ...
	 */
	void setAttackQuickness(CreatureMovementSpeedType::Type attack_quickness) {
		attack_quickness_ = attack_quickness;
	}
	 ...
	 */
	CreatureMovementSpeedType::Type attackQuickness() const {
		return attack_quickness_;
	}

	/**
	 * @brief Set the maximum pace of the animal
	 * @param max_pace Pointer to the maximum pace of the animal, used to determine how far it can move in a turn based on its movement speed. This is stored as a pointer to avoid having to copy the pace data for each animal and instead
	 * just reference the same data for all animals with the same movement speed.
	 */
	void setMaxPace(const CreaturePaceData& max_pace) {
		max_pace_ = &max_pace;
	}

	/**
	 * @brief Get the pace data for the animal
	 * @return Pointer to the pace data for the animal, used to determine how far it can move in a turn based on its movement speed. This is stored as a pointer to avoid having to copy the pace data for each animal and instead just
	 * reference the same data for all animals with the same movement speed.
	 */
	const CreaturePaceData* maxPace() const {
		return max_pace_;
	}
	 ...
	 */
	void setOutlook(AnimalOutlookType::Type outlook) {
		outlook_ = outlook;
	}
	 ...
	 */
	AnimalOutlookType::Type outlook() const {
		return outlook_;
	}
	 ...
	 */
	void setCriticalTableType(CriticalSizeTableType::Type critical_table_type) {
		critical_table_type_ = critical_table_type;
	}
	 ...
	 */
	CriticalSizeTableType::Type criticalTableType() const {
		return critical_table_type_;
	}
	 ...
	 */
	void addCriticalModifier(CriticalModifierType::Type critical_modifier) {
		critical_modifiers_.emplace(critical_modifier);
	}
	 ...
	 */
	void setCriticalModifiers(std::set<CriticalModifierType::Type> critical_modifiers) {
		critical_modifiers_ = std::move(critical_modifiers);
	}
	 ...
	 */
	const std::set<CriticalModifierType::Type>& criticalModifiers() const {
		return critical_modifiers_;
	}
	 ...
	 */
	void setEncounterRange(std::pair<int, int> encounter_range) {
		encounter_range_ = encounter_range;
	}
	 ...
	 */
	const std::pair<int, int> encounterRange() const {
		return encounter_range_;
	}
	 ...
	 */
	void setNumberYoungRange(std::pair<int, int> number_young_range) {
		number_young_range_ = number_young_range;
	}
	 ...
	 */
	const std::pair<int, int> numberYoungRange() const {
		return number_young_range_;
	}
	 ...
	 */
	void addAttack(const archid::NumberRange<int>* chance_range, rm::game::AnimalAttack attack) {
		attacks_.emplace(chance_range, std::move(attack));
	}

	/**
	 * @brief Get the map of attacks for the animal
	 * @return Map of attack data for the animal, keyed by a pointer to a NumberRange<int> that represents the chance of the attack being used in a round. This is stored as a pointer to avoid having to copy the attack data for each animal
	 * and instead just reference the same data for all animals with the same attack chances.
	 */
	const std::map<const archid::NumberRange<int>*, rm::game::AnimalAttack>& attacks() const {
		return attacks_;
	}
	 ...
	 */
	rm::game::AnimalAttack getAttack(int d100_roll) const {
		return getAttack(1, d100_roll);
	};

	/**
	 * @brief Get the attack for a given d100 roll
	 * @param num_attackers The number of attackers in the round, used to determine which attack is used in a round based on the chance ranges defined for each attack. This is used to determine if the attack should be used based on the
	 * number of attackers in the round and the chance range for the attack. For example, an attack may only be used if there are 2 or more attackers in the round, so if there is only 1 attacker then that attack would not be used regardless
	 * of the d100 roll.
	 * @param d100_roll The result of a d100 roll, used to determine which attack is used in a round based on the chance ranges defined for each attack.
	 * @return The attack for the given d100 roll, determined by finding the first attack in the attacks map where the d100 roll falls within the chance range key. If no such attack is found, a default constructed AnimalAttack is returned.
	 */
	 ...
	 * If there are multiple of these defined the one with the largest group size that is less than or equal to the number of attackers in the round will be used. For example, if there are attacks defined for 2 or more attackers and 4 or
	 * more attackers and there are 3 attackers in the round then the attack for 2 or more attackers will be used as it is the largest group size that is less than or equal to the number of attackers in the round.
	 *
	 * @param num_attackers The number of attackers in the round, used to determine if the attack should be used based on the number of attackers in the round and the chance range for the attack. For example, an attack may only be used if
	 * there are 2 or more attackers in the round, so if there is only 1 attacker then that attack would not be used regardless of the d100 roll.
	 ...
	 */
	void addGroupAttack(int num_attackers, rm::game::AnimalAttack attack) {
		group_attacks_.emplace(num_attackers, std::move(attack));
	}
	 ...
	 * more attackers and there are 3 attackers in the round then the attack for 2 or more attackers will be used as it is the largest group size that is less than or equal to the number of attackers in the round.
	 *
	 * @return Map of attack data for the animal, keyed by the number of attackers in the round. This is used to determine if the attack should be used based on the number of attackers in the round and the chance range for the attack. For
	 * example, an attack may only be used if there are 2 or more attackers in the round, so if there is only 1 attacker then that attack would not be used regardless of the d100 roll.
	 */
	const std::map<int, rm::game::AnimalAttack>& groupAttacks() const {
		return group_attacks_;
	}
	 ...
	 * more attackers and there are 3 attackers in the round then the attack for 2 or more attackers will be used as it is the largest group size that is less than or equal to the number of attackers in the round.
	 *
	 * The reurn value needs to be checked to see if an attack was found for the given number of attackers in the round as it is possible that there are no attacks defined for the number of attackers in the round. For example, if there are
	 * attacks defined for 4 or more attackers and 6 or more attackers and there are only 3 attackers in the round then no attack would be found and an empty optional would be returned.
	 *
	 * @param num_attackers The number of attackers in the round, used to determine if the attack should be used based on the number of attackers in the round and the chance range for the attack. For example, an attack may only be used if
	 * there are 2 or more attackers in the round, so if there is only 1 attacker then that attack would not be used regardless of the d100 roll.
	 * @return The attack for the given number of attackers in the round, determined by finding the attack in the attacks_by_num_attackers map with the largest key that is less than or equal to the number of attackers in the round. If no
	 * such attack is found, a default constructed AnimalAttack is returned.
	 */
	 ...
	 */
	void addRangedAttack(rm::game::AnimalAttack attack) {
		ranged_attacks_.emplace_back(std::move(attack));
	}
	 ...
	 */
	const std::vector<rm::game::AnimalAttack>& rangedAttacks() const {
		return ranged_attacks_;
	}

	/**
	 * @brief Add a conditional attack to the animal
	 *
	 * A conditional attack is an attack that is only used if a certain condition is met. The condition is determined by the reference integer which can be used to look up the condition in a table or to determine the condition in some other
	 * way. For example, the reference integer could be used to determine if the attack is only used during a certain phase of combat or if it is only used if the animal has taken a certain amount of damage.
	 *
	 ...
	 * @param attack AnimalAttack object that represents the conditional attack, used to determine the details of the attack and as the value for the conditional attack in the conditional_attacks map with the key being the reference integer
	 * for the condition under which the attack is used.
	 */
	void addConditionalAttack(int ref, rm::game::AnimalAttack attack) {
		conditional_attacks_.emplace(ref, std::move(attack));
	}
	 ...
	 * way. For example, the reference integer could be used to determine if the attack is only used during a certain phase of combat or if it is only used if the animal has taken a certain amount of damage.
	 *
	 * The return value needs to be checked to see if an attack was found for the given reference integer as it is possible that there are no attacks defined for the reference integer. For example, if there are attacks defined for reference
	 * integers 1 and 2 and the reference integer 3 is passed in then no attack would be found and an empty optional would be returned.
	 *
	 * @param ref The reference integer for the conditional attack, used to determine the condition under which the attack is used.
	 ...
	 * way. For example, the reference integer could be used to determine if the attack is only used during a certain phase of combat or if it is only used if the animal has taken a certain amount of damage.
	 *
	 * @return Map of conditional attack data for the animal, keyed by the reference integer for the condition under which the attack is used. This is used to determine which attacks are conditional attacks and to look up the details of the
	 * conditional attacks based on the reference integer for the condition under which they are used.
	 */
	const std::map<int, rm::game::AnimalAttack>& conditionalAttacks() const {
		return conditional_attacks_;
	}
...
private:
	...
	std::optional<const TreasureCodeData*>
	    treasure_code_{}; /**< Optional pointer to a TreasureCodeData object that represents the treasure that can be found on the animal or in it's lair when it is killed. This is optional as not all animals will have treasure. */
	...
	const CreaturePaceData* max_pace_{}; /**< Pointer to the maximum pace of the animal, used to determine how far it can move in a turn based on its movement speed. This is stored as a pointer to avoid having to copy the pace data for each
	                                        animal and instead just reference the same data for all animals with the same movement speed. */
	...
	std::map<int, rm::game::AnimalAttack> group_attacks_{}; /**< Map of attack data for the animal, keyed by the number of attackers in the round. This is used to determine if the attack should be used based on the number of attackers in
	                                                           the round. For example, an attack may only be used if there are 2 or more attackers in the round. */
	std::vector<rm::game::AnimalAttack>
	    ranged_attacks_{}; /**< Vector of ranged attack data for the animal, used to determine which attacks are ranged attacks. This is used to determine if the animal can make ranged attacks and which attacks are ranged attacks. */
