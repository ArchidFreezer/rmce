...
namespace rm::rule::parser {
	...
	public:
		 ...
		 */
		TrainingPackageCostTableDatafileParser(rm::GameRuleDataFactory& object_manager, std::string_view filename) : DatafileParser(object_manager, "TrainingPackageCostTable", filename) {}
