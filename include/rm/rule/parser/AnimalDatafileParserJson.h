...
namespace rm::rule::parser {
	...
	public:
		 ...
		 */
		AnimalDatafileParserJson(rm::PersistentObjectManager& object_manager, std::string_view filename) : DatafileParserJson(object_manager, "Animal", filename) {
			setRootNode("animals");
		}
		 ...
		 * @param object_manager Reference to an object manager to handle the data objects
		 */
		AnimalDatafileParserJson(rm::PersistentObjectManager& object_manager) : AnimalDatafileParserJson(object_manager, "") {}
