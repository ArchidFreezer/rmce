...
namespace rm::rule::parser {
	...
	public:
		 ...
		 */
		SkillGroupDatafileParserJson(rm::GameRuleDataFactory& object_manager, std::string_view filename) : DatafileParserJson(object_manager, "SkillGroup", filename) {
		 ...
		 * @param object_manager Reference to an object manager to handle the data objects
		 */
		SkillGroupDatafileParserJson(rm::GameRuleDataFactory& object_manager) : SkillGroupDatafileParserJson(object_manager, "") {}
