...
public:
	...
	inline static std::string prefix_{"RACE"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setHighCulture(bool high_culture) {
		high_culture_ = high_culture;
	}
	 ...
	 */
	bool highCulture() const {
		return high_culture_;
	}
	 ...
	 */
	void setCriticalTableType(CriticalTableType::Type critical_table_type) {
	 ...
	 */
	CriticalTableType::Type criticalTableType() const {
	 ...
	 */
	void setRecoveryMultiplier(float recovery_multiplier) {
		recovery_multipler_ = recovery_multiplier;
	}
	 ...
	 */
	float recoveryMultiplier() const {
		return recovery_multipler_;
	}
	 ...
	 */
	void setNumBackgroundOptions(int num_background_options) {
		num_background_options_ = num_background_options;
	}
	 ...
	 */
	int numBackgroundOptions() const {
		return num_background_options_;
	}
	 ...
	 */
	void setExhaustionBonus(int exhaustion_bonus) {
		exhaustion_bonus_ = exhaustion_bonus;
	}
	 ...
	 */
	int exhaustionBonus() const {
		return exhaustion_bonus_;
	}
	 ...
	 */
	void setStatLossRacialType(int stat_loss_racial_type) {
		stat_loss_racial_type_ = stat_loss_racial_type;
	}
	 ...
	 */
	int statLossRacialType() const {
		return stat_loss_racial_type_;
	}
	 ...
	 */
	void setRequiredSleep(int required_sleep) {
		required_sleep_ = required_sleep;
	}
	 ...
	 */
	int requiredSleep() const {
		return required_sleep_;
	}
	 ...
	 */
	void setRequiredSleepFrequency(int required_sleep_frequency) {
		required_sleep_frequency_ = required_sleep_frequency;
	}
	 ...
	 */
	int requiredSleepFrequency() const {
		return required_sleep_frequency_;
	}
	 ...
	 */
	void setSoulDeparture(int soul_departure) {
		soul_departure_ = soul_departure;
	}
	 ...
	 */
	int soulDeparture() const {
		return soul_departure_;
	}
	 ...
	 */
	void setBuildModifier(int build_modifier) {
		build_modifier_ = build_modifier;
	}
	 ...
	 */
	int buildModifier() const {
		return build_modifier_;
	}
	 ...
	 */
	void setAverageMaleHeight(int average_male_height) {
		average_male_height_ = average_male_height;
	}
	 ...
	 */
	int averageMaleHeight() const {
		return average_male_height_;
	}
	 ...
	 */
	void setAverageFemaleHeight(int average_female_height) {
		average_female_height_ = average_female_height;
	}
	 ...
	 */
	int averageFemaleHeight() const {
		return average_female_height_;
	}
	 ...
	 */
	void setAverageLifespan(int average_lifespan) {
		average_lifespan_ = average_lifespan;
	}
	 ...
	 */
	int averageLifespan() const {
		return average_lifespan_;
	}
	 ...
	 */
	void setMaleWeightModifier(int male_weight_modifier) {
		male_weight_modifier_ = male_weight_modifier;
	}
	 ...
	 */
	int maleWeightModifier() const {
		return male_weight_modifier_;
	}
	 ...
	 */
	void setFemaleWeightModifier(int female_weight_modifier) {
		female_weight_modifier_ = female_weight_modifier;
	}
	 ...
	 * @return weight generation modifier
	 */
	int femaleWeightModifier() const {
		return female_weight_modifier_;
	}
	 ...
	 */
	void setArmsProgression(const SkillProgressionTypeData& arms_progression) {
		arms_progression_ = &arms_progression;
	}
	 ...
	 */
	const SkillProgressionTypeData& armsProgression() const {
		return *arms_progression_;
	}
	 ...
	 */
	void setArcaneProgression(const SkillProgressionTypeData& arcane_progression) {
		arcane_progression_ = &arcane_progression;
	}
	 ...
	 * @return Reference to the SkillProgressionTypeData containing the progression
	 */
	const SkillProgressionTypeData& arcaneProgression() const {
		return *arcane_progression_;
	}
	 ...
	 */
	void setChannelingProgression(const SkillProgressionTypeData& channeling_progression) {
		channeling_progression_ = &channeling_progression;
	}
	 ...
	 * @return Reference to the SkillProgressionTypeData containing the progression
	 */
	const SkillProgressionTypeData& channelingProgression() const {
		return *channeling_progression_;
	}
	 ...
	 */
	void setEssenceProgression(const SkillProgressionTypeData& essence_progression) {
		essence_progression_ = &essence_progression;
	}
	 ...
	 * @return Reference to the SkillProgressionTypeData containing the progression
	 */
	const SkillProgressionTypeData& essenceProgression() const {
		return *essence_progression_;
	}
	 ...
	 */
	void setMentalismProgression(const SkillProgressionTypeData& mentalism_progression) {
		mentalism_progression_ = &mentalism_progression;
	}
	 ...
	 * @return Reference to the SkillProgressionTypeData containing the progression
	 */
	const SkillProgressionTypeData& mentalismProgression() const {
		return *mentalism_progression_;
	}
	 ...
	 * @param bonus value of bonus
	 */
	void setStatBonus(StatType::Type stat, int bonus) {
		stat_bonuses_.emplace(stat, bonus);
	}
	 ...
	 */
	void setStatBonuses(std::map<StatType::Type, int> stat_bonuses) {
		stat_bonuses_ = std::move(stat_bonuses);
	}
	 ...
	 */
	const std::map<StatType::Type, int>& statBonuses() const {
	 ...
	 * @return bonus value
	 */
	int statBonus(StatType::Type stat) const {
		return stat_bonuses_.count(stat) ? stat_bonuses_.at(stat) : 0;
	}
	 ...
	 */
	void addEverymanSkill(const SubcategoriedSkillData& skill) {
		if (isRestrictedSkill(skill.skillData(), skill.subcategory()))
			throw InvalidSkillDevelopment("Cannot set " + skill.id() + " as everyman as it is already set as restricted");
		if (isEverymanSkill(skill.skillData(), skill.subcategory()))
			throw InvalidSkillDevelopment("Cannot set " + skill.id() + " as everyman as it is already defined");
	 ...
	 */
	void setEverymanSkills(std::set<const SubcategoriedSkillData*> skills) {
		everyman_skills_ = std::move(skills);
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	const std::set<const SubcategoriedSkillData*> everymanSkills() const {
		return everyman_skills_;
	}
	...
	bool isEverymanSkill(const SkillData& other, std::optional<std::string_view> subcategory = std::nullopt) const {
		for (auto& skill : everyman_skills_) {
			if (skill->skillData().id() == other.id() && (subcategory ? subcategory.value() == skill->subcategory() : !skill->subcategory()))
				return true;
		}
		return false;
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	void addRestrictedSkill(const SubcategoriedSkillData& skill) {
		if (isEverymanSkill(skill.skillData(), skill.subcategory()))
			throw InvalidSkillDevelopment("Cannot set " + skill.id() + " as restricted as it is already set as everyman");
		if (isRestrictedSkill(skill.skillData(), skill.subcategory()))
			throw InvalidSkillDevelopment("Cannot set " + skill.id() + " as restricted as it is already defined");
	 ...
	 */
	const std::set<const SubcategoriedSkillData*> restrictedSkills() const {
		return restricted_skills_;
	}
	 ...
	 */
	void setRestrictedSkills(std::set<const SubcategoriedSkillData*> skills) {
		restricted_skills_ = std::move(skills);
	}
	...
	void addEverymanSkillCategory(const SkillCategoryData& category) {
		if (isRestrictedSkillCategory(category))
			throw InvalidSkillDevelopment("Cannot set " + category.id() + " as everyman as it is already set as restricted");
		if (isEverymanSkillCategory(category))
			throw InvalidSkillDevelopment("Cannot set " + category.id() + " as everyman as it is already defined");
	 ...
	 */
	const std::set<const SkillCategoryData*> everymanSkillCategories() const {
		return everyman_skill_categories_;
	}
	...
	void addRestrictedSkillCategory(const SkillCategoryData& category) {
		if (isEverymanSkillCategory(category))
			throw InvalidSkillDevelopment("Cannot set " + category.id() + " as restricted as it is already set as everyman");
		if (isRestrictedSkillCategory(category))
			throw InvalidSkillDevelopment("Cannot set " + category.id() + " as restricted as it is already defined");
	 ...
	 */
	void setRestrictedSkillCategories(std::set<const SkillCategoryData*> categories) {
		restricted_skill_categories_ = std::move(categories);
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	const std::set<const SkillCategoryData*> restrictedSkillCategories() const {
		return restricted_skill_categories_;
	}
	...
	void setSkillBonus(SubcategoriedSkillData& skill, int bonus) {
		if (isBonusSkill(skill.skillData(), skill.subcategory()))
			throw InvalidSkillBonus("There is already a bonus set for skill " + skill.id());
	 ...
	 */
	void setSkillBonuses(std::map<const SubcategoriedSkillData*, int> bonuses) {
		skill_bonuses_ = std::move(bonuses);
	}
	 ...
	 */
	const std::map<const SubcategoriedSkillData*, int>& skillBonuses() const {
		return skill_bonuses_;
	}
	...
	bool isBonusSkill(const SkillData& skill, std::optional<std::string_view> subcategory = std::nullopt) const {
		for (auto& key : std::views::keys(skill_bonuses_)) {
			if (key->skillData().id() == skill.id() && (subcategory ? subcategory.value() == key->subcategory().value() : !key->subcategory()))
				return true;
		}
		return false;
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	void addCategoryEverymanSkillChoice(GameRuleDataChoice<SkillCategoryData> choice) {
		category_everyman_skill_choices_.emplace(std::move(choice));
	}
	 ...
	 */
	void setCategoryEverymanSkillChoices(std::set<GameRuleDataChoice<SkillCategoryData>> choices) {
		category_everyman_skill_choices_ = std::move(choices);
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	int numCategoryEverymanSkillChoices() const {
		return category_everyman_skill_choices_.size();
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	const std::set<GameRuleDataChoice<SkillCategoryData>>& categoryEverymanSkillChoices() const {
		return category_everyman_skill_choices_;
	}
...
private:
	...
	std::map<const SubcategoriedSkillData*, int> skill_bonuses_{};                             /** Racial skill bonuses */
