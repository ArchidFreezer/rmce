...
public:
	...
	inline static std::string prefix_{"TREASURECODE"}; /**< Prefix for the ID of the data objects */
	...
	std::string_view prefix() const override {
		return TreasureCodeData::prefix_;
	}
	 ...
	 */
	void setItemsValueType(TreasureValueType::Type items_value_type) {
		items_value_type_ = items_value_type;
	}
	 ...
	 */
	TreasureValueType::Type itemsValueType() const {
		return items_value_type_;
	}
	 ...
	 */
	void setWealthValueType(TreasureValueType::Type wealth_value_type) {
		wealth_value_type_ = wealth_value_type;
	}
	 ...
	 */
	TreasureValueType::Type wealthValueType() const {
		return wealth_value_type_;
	}
