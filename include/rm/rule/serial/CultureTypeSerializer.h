 ...
 */
class CultureTypeSerializer : public PersistentObjectSerializer<CultureTypeData> {
public:
	...
	using PersistentObjectSerializer<CultureTypeData>::serializeObject;
	 ...
	 */
	CultureTypeSerializer(rm::PersistentObjectManager& manager) : PersistentObjectSerializer<CultureTypeData>(manager) {
	}
