...
public:
	...
	inline static std::string prefix_{"POISONTYPE"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void addEffectOnset(DiseasePoisonSeverityType::Type severity, const archid::NumberRange<int>* effectOnset) {
		effectOnsetBySeverity_[severity] = effectOnset;
	}
	 ...
	 */
	void setEffectOnsets(std::map<DiseasePoisonSeverityType::Type, const archid::NumberRange<int>*> effectOnsetBySeverity) {
		effectOnsetBySeverity_ = std::move(effectOnsetBySeverity);
	}
	 ...
	 */
	const std::map<DiseasePoisonSeverityType::Type, const archid::NumberRange<int>*>& effectOnsets() const {
		return effectOnsetBySeverity_;
	}
	 ...
	 */
	void addSymptom(DiseasePoisonSeverityType::Type severity, std::string symptoms) {
		symptomsBySeverity_[severity] = std::move(symptoms);
	}
	 ...
	 */
	void setSymptoms(std::map<DiseasePoisonSeverityType::Type, std::string> symptomsBySeverity) {
		symptomsBySeverity_ = std::move(symptomsBySeverity);
	}
	 ...
	 */
	const std::map<DiseasePoisonSeverityType::Type, std::string>& symptoms() const {
		return symptomsBySeverity_;
	}
	 ...
	 */
	void setAreasAffected(std::string areasAffected) {
		areasAffected_ = std::move(areasAffected);
	}
	 ...
	 */
	const std::string& areasAffected() const {
		return areasAffected_;
	}
