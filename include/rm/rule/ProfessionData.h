...
public:
	...
	inline static std::string prefix_{"PROFESSION"}; /**< Prefix for the ID of the data objects */
	 ...
	 */
	void setSpellUserType(SpellUserType::Type spell_user_type) {
		spell_user_type_ = spell_user_type;
	}
	 ...
	 */
	void addBaseSpellListChoice(GameRuleDataChoice<SpellListData> choice) {
		base_spell_list_choices_.emplace(std::move(choice));
	}
	 ...
	 */
	void setBaseSpellListChoices(std::set<GameRuleDataChoice<SpellListData>> choices) {
		base_spell_list_choices_ = std::move(choices);
	}
	 ...
	 */
	int numBaseSpellListChoices() const {
		return base_spell_list_choices_.size();
	}
	 ...
	 */
	const std::set<GameRuleDataChoice<SpellListData>>& baseSpellListChoices() const {
		return base_spell_list_choices_;
	}
	 ...
	 */
	void addSkillDevelopmentTypeChoice(GameRuleDataChoice<SubcategoriedSkillData> choice, SkillDevelopmentType::Type type) {
		skill_development_type_choices_.emplace(std::move(choice), type);
	}
	 ...
	 */
	void setSkillDevelopmentTypeChoices(std::map<GameRuleDataChoice<SubcategoriedSkillData>, SkillDevelopmentType::Type> choices) {
		skill_development_type_choices_ = std::move(choices);
	}
	 ...
	 */
	int numSkillDevelopmentTypeChoices() const {
		return skill_development_type_choices_.size();
	}
	 ...
	 */
	const std::map<GameRuleDataChoice<SubcategoriedSkillData>, SkillDevelopmentType::Type>& skillDevelopmentTypeChoices() const {
		return skill_development_type_choices_;
	}
	 ...
	 * @param type SkillDevelopmentType::Type type choices will have
	 */
	void addSkillCategorySkillDevelopmentTypeChoice(GameRuleDataChoice<SkillCategoryData> choice, SkillDevelopmentType::Type type) {
		skill_category_skill_development_type_choices_.emplace(std::move(choice), type);
	}
	 ...
	 */
	void setSkillCategorySkillDevelopmentTypeChoices(std::map<GameRuleDataChoice<SkillCategoryData>, SkillDevelopmentType::Type> choices) {
		skill_category_skill_development_type_choices_ = std::move(choices);
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	int numSkillCategorySkillDevelopmentTypeChoices() const {
		return skill_category_skill_development_type_choices_.size();
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	const std::map<GameRuleDataChoice<SkillCategoryData>, SkillDevelopmentType::Type>& skillCategorySkillDevelopmentTypeChoices() const {
		return skill_category_skill_development_type_choices_;
	}
	 ...
	 * @param type SkillDevelopmentType::Type type choices will have
	 */
	void addSkillGroupSkillDevelopmentTypeChoice(GameRuleDataChoice<SkillGroupData> choice, SkillDevelopmentType::Type type) {
		skill_group_skill_development_type_choices_.emplace(std::move(choice), type);
	}
	 ...
	 */
	void setSkillGroupSkillDevelopmentTypeChoices(std::map<GameRuleDataChoice<SkillGroupData>, SkillDevelopmentType::Type> choices) {
		skill_group_skill_development_type_choices_ = std::move(choices);
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	int numSkillGroupSkillDevelopmentTypeChoices() const {
		return skill_group_skill_development_type_choices_.size();
	}
	 ...
	 * @see SkillDevelopmentType
	 */
	const std::map<GameRuleDataChoice<SkillGroupData>, SkillDevelopmentType::Type>& skillGroupSkillDevelopmentTypeChoices() const {
		return skill_group_skill_development_type_choices_;
	}
	 ...
	 */
	void addSkillGroupSpecialBonus(const SkillGroupData& group, int bonus) {
		skill_group_special_bonuses_.emplace(&group, bonus);
	}
	 ...
	 */
	void setSkillGroupSpecialBonuses(std::map<const SkillGroupData*, int> bonuses) {
		skill_group_special_bonuses_ = std::move(bonuses);
	}
	 ...
	 */
	const std::map<const SkillGroupData*, int>& skillGroupSpecialBonuses() const {
		return skill_group_special_bonuses_;
	}
	 ...
	 * @param bonus bonus value
	 */
	void addSkillGroupProfessionBonus(const SkillGroupData& group, int bonus) {
		skill_group_profession_bonuses_.emplace(&group, bonus);
	}
	 ...
	 * @param bonuses A map whose keys are pointers to SkillGroupData and whose values are integer bonus amounts.
	 */
	void setSkillGroupProfessionBonuses(std::map<const SkillGroupData*, int> bonuses) {
		skill_group_profession_bonuses_ = std::move(bonuses);
	}
	 ...
	 * @return std::map of const SkillGroupData* and bonus value
	 */
	const std::map<const SkillGroupData*, int>& skillGroupProfessionBonuses() const {
		return skill_group_profession_bonuses_;
	}
	 ...
	 */
	void setSkillDevelopmentTypes(std::map<const SubcategoriedSkillData*, SkillDevelopmentType::Type> types) {
		skill_development_types_ = std::move(types);
	}
	 ...
	 */
	const std::map<const SubcategoriedSkillData*, SkillDevelopmentType::Type>& skillDevelopmentTypes() const {
		return skill_development_types_;
	}
	 ...
	 * @param type SkillDevelopmentType::Type value to set
	 */
	void addSkillCategorySkillDevelopmentType(const SkillCategoryData& category, SkillDevelopmentType::Type type) {
		skill_category_skill_development_types_.emplace(&category, type);
	}
	 ...
	 */
	void setSkillCategorySkillDevelopmentTypes(std::map<const SkillCategoryData*, SkillDevelopmentType::Type> types) {
		skill_category_skill_development_types_ = std::move(types);
	}
	 ...
	 */
	const std::map<const SkillCategoryData*, SkillDevelopmentType::Type>& skillCategorySkillDevelopmentTypes() const {
		return skill_category_skill_development_types_;
	}
	...
	SkillDevelopmentType::Type skillCategorySkillDevelopmentType(const SkillCategoryData& category) {
		for (auto& cat : std::views::keys(skill_category_skill_development_types_)) {
			if (cat->id() == category.id())
				return skill_category_skill_development_types_.at(cat);
		}
		return SkillDevelopmentType::kStandard;
	}
	 ...
	 */
	void addSkillGroupSkillDevelopmentType(const SkillGroupData& group, SkillDevelopmentType::Type type) {
		skill_group_skill_development_types_.emplace(&group, type);
	}
	 ...
	 */
	void setSkillGroupSkillDevelopmentTypes(std::map<const SkillGroupData*, SkillDevelopmentType::Type> types) {
		skill_group_skill_development_types_ = std::move(types);
	}
	 ...
	 */
	const std::map<const SkillGroupData*, SkillDevelopmentType::Type>& skillGroupSkillDevelopmentTypes() const {
		return skill_group_skill_development_types_;
	}
	...
	SkillDevelopmentType::Type skillGroupSkillDevelopmentType(const SkillGroupData& group) const {
		for (auto& key : std::views::keys(skill_group_skill_development_types_)) {
			if (key->id() == group.id())
				return skill_group_skill_development_types_.at(key);
		}
		return SkillDevelopmentType::kStandard;
	}
	 ...
	 */
	void addSkillCategorySpecialBonus(const SkillCategoryData& category, int bonus) {
		skill_category_special_bonuses_.emplace(&category, bonus);
	}
	 ...
	 */
	void setSkillCategorySpecialBonuses(std::map<const SkillCategoryData*, int> bonuses) {
		skill_category_special_bonuses_ = std::move(bonuses);
	}
	 ...
	 */
	const std::map<const SkillCategoryData*, int>& skillCategorySpecialBonuses() const {
		return skill_category_special_bonuses_;
	}
	...
	int skillCategorySpecialBonus(const SkillCategoryData& category) {
		for (auto& cat : std::views::keys(skill_category_special_bonuses_)) {
			if (cat->id() == category.id())
				return skill_category_special_bonuses_.at(cat);
		}
		return 0;
	}
	 ...
	 * @param bonus int bonus value
	 */
	void addSkillCategoryProfessionBonus(const SkillCategoryData& category, int bonus) {
		skill_category_profession_bonuses_.emplace(&category, bonus);
	}
	 ...
	 */
	void setSkillCategoryProfessionBonuses(std::map<const SkillCategoryData*, int> bonuses) {
		skill_category_profession_bonuses_ = std::move(bonuses);
	}
	 ...
	 * @return std::map of const SkillCategoryData* and bonus value
	 */
	const std::map<const SkillCategoryData*, int>& skillCategoryProfessionBonuses() const {
		return skill_category_profession_bonuses_;
	}
	...
	int skillCategoryProfessionBonus(const SkillCategoryData& category) {
		for (auto& cat : std::views::keys(skill_category_profession_bonuses_)) {
			if (cat->id() == category.id())
				return skill_category_profession_bonuses_.at(cat);
		}
		return 0;
	}
	 ...
	 */
	void addSkillCategoryDevelopmentCost(const SkillCategoryData& category, rm::game::character::SkillDevelopmentCost cost) {
		skill_category_development_costs_.emplace(&category, std::move(cost));
	}
	...
	const rm::game::character::SkillDevelopmentCost& skillCategoryDevelopmentCost(const SkillCategoryData& category) const {
		for (auto& cat : std::views::keys(skill_category_development_costs_)) {
			if (cat->id() == category.id())
				return skill_category_development_costs_.at(cat);
		}
