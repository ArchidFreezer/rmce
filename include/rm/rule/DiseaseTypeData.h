...
public:
	...
	inline static std::string prefix_{"DISEASETYPE"}; /**< Prefix for the ID of the data objects */
	...
	std::string_view prefix() const override {
		return DiseaseTypeData::prefix_;
	}
	 ...
	 */
	const std::string& transmission() const {
