 ...
 *
 * Each category is associated with a skill category data object, which provides information about the category and its associated stats. The category also has its own progression type, which determines how the bonus from ranks is
 * calculated. Additionally, the category may have a profession bonus and a special bonus from other sources, which are added to the total bonus for the category.
 */
class Category {
