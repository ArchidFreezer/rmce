 ...
 *
 * Each skill is associated with a category, which provides a bonus based on the number of ranks allocated to it. The skill also has its own progression type, which determines how the bonus from ranks is calculated. Additionally, the skill may have
 * a profession bonus and a special bonus from other sources, which are added to the total bonus for the skill.
 */
class Skill {
