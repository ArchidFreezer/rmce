...
Dice::Dice(int sides, int open_ended_high_range, int open_ended_low_range) : sides_{ std::max(sides, 1) }, min_open_high_{ std::max(2,sides - open_ended_high_range + 1) }, max_open_low_{ std::min(open_ended_low_range, sides_ - 1) } {}
