...
public:
   ...
   *        _invalidate_ the object referenced in the parameter
	 ...
	 */
	const std::string& id() { return name(); }
	 ...
	 */
	const std::set<std::string>& dialects() { return dialects_; }
	 ...
	 */
	const bool isDialect(const std::string& language) const { return dialects_.count(language) >  0; }
