...
namespace {
	 ...
	 */
	class DummyLookupTable : public rule::LookupTable<archid::NumberRange<int>, int, rule::TableColumnCreatureSizeMatcher, rule::enums::CreatureSizeType::Type, std::string> {
	public:
